...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action='service/pay' method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>卖家支付宝帐户：</dt>
                  <dd>
                        <span class="null-star">*</span>
                        <input size="30" value="william@speakez.cn" name="WIDseller_email" />
                        <span></span>
                    </dd>
                    <dt>商户订单号：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" value="Test" name="WIDsubject" />
                        <span></span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
